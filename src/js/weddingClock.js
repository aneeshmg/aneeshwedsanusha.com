function weddingCountdown(settings) {
    let glob = settings
    ...
    let clock = {
        set: {
            days: function(){
                let cdays = $("#canvas_days").get(0)
                let ctx = cdays.getContext("2d")
            ...
            hours: function() {
                let cHr = $("#canvas_hours").get(0)
                let ctx = cHr.getContext("2d")
            ...
            minutes : function(){
                let cMin = $("#canvas_minutes").get(0)
                let ctx = cMin.getContext("2d")
            ...
            seconds: function(){
                let cSec = $("#canvas_seconds").get(0)
                let ctx = cSec.getContext("2d")
